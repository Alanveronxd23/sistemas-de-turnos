...
const Informacion = () => {
    ...
    return (
        <>
            ...
            <a href="https://wa.me/5493416923641?text=Hola%2C%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20el%20servicio%20de%20control%20de%20gastos" className="whatsapp-float" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
